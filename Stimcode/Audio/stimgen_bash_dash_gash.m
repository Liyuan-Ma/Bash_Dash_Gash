...
%         stereo_audio = left_stream_audio + right_stream_audio; %[left_audio(:,1), right_audio(:,2)];
        ...
        file_paths{file_paths_counter, 1} = filename;
...
file_paths_table = cell2table(file_paths, 'VariableNames', {'sound'});

% Save the table as an Excel file
excel_filename = fullfile(output_folder, 'audio_file_paths.xlsx');
writetable(file_paths_table, excel_filename, 'WriteVariableNames', false);
