...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Lab User\\Documents\\Bash_Dash_Gash\\Stimcode\\Audio\\Trial_run\\test2.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    for trial_num, thisTrial in enumerate(trials):
        ...
        while continueRoutine and routineTimer.getTime() < 10.000589999999999:
            ...
            # *** FIXED: Ensure we get 3 key responses and save them to file ***
        ...
        # Ensure three responses are captured
