...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\New_exp\\Stimcode\\Audio\\Trial_run\\Trial_mult_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        sound_1.setSound(audio, secs=3.750590, hamming=True)
        ...
        thisExp.addData('response1', key_resp.keys[0])
        thisExp.addData('response2', key_resp.keys[1])
        thisExp.addData('response3', key_resp.keys[2])
